  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-to-r from-gold to-gold-light text-primary-foreground font-semibold hover:shadow-gold hover:scale-[1.02]",
        goldOutline: "border-2 border-gold text-gold hover:bg-gold hover:text-primary-foreground",
        hero: "bg-gradient-to-r from-gold to-gold-light text-primary-foreground font-semibold text-base px-8 py-6 hover:shadow-gold hover:scale-[1.02]",
        heroOutline: "border-2 border-gold text-gold font-semibold text-base px-8 py-6 hover:bg-gold/10",
      },
      size: {

  ...
  "rounded-lg border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card border-border shadow-card hover:shadow-gold",
        gold: "bg-card border-gold/30 shadow-card hover:border-gold/60",
        glass: "bg-card/50 backdrop-blur-md border-border/50",
        premium: "bg-gradient-to-b from-card to-background border-gold/20 shadow-card",
      },
    },
    defaultVariants: {
      variant: "default",

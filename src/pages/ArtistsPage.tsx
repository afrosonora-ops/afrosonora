        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <Input type="text" placeholder="Pesquisar artistas..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-10 bg-card border-border" />
              </div>
          ...
          {!loading && filteredArtists.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="font-display text-xl font-semibold text-foreground mb-2">Nenhum artista encontrado</h3>
          ...
          <div className="text-center mt-16 p-8 rounded-xl bg-charcoal border border-border">
            <h3 className="font-display text-2xl font-bold text-foreground mb-3">É artista e quer aparecer aqui?</h3>
            <p className="text-muted-foreground mb-6">Crie o seu perfil na AFROSONORA e conecte-se com promotores europeus.</p>
            <Link to="/registo"><Button variant="gold" size="lg">Criar Perfil de Artista</Button></Link>
          </div>
        </div>
      </main>
      <Footer />

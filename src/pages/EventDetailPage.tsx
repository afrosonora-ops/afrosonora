        ...
        jsonLd={[
          {
            ...
            description: event.shortDescription,
            url: `https://afrosonora.com/eventos/${event.slug}`,
            inLanguage: "pt-PT",
          ...
          },
          {
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Início", item: "https://afrosonora.com/" },
              { "@type": "ListItem", position: 2, name: "Eventos", item: "https://afrosonora.com/eventos" },
              {
                "@type": "ListItem",
                position: 3,
                name: event.title,
                item: `https://afrosonora.com/eventos/${event.slug}`,
              },
            ],
          },
        ]}
